...
class NHitsForecaster:
    ...
    def prepare_data(self):
        ...
        logging.info(f"Prepared {len(y_df)} data points with " +
    ...
    def run_forecast(self):
        ...
        try:
            ...
            plotter = ResultPlotter(self.symbol, self.ohlcv_df, 
                                    self.y_df, self.forecast_df)
            plotter.plot_absolute_prices(timeframe_configs=self.timeframe_configs, 
