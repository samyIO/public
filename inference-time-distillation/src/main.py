...
def run_chat():
    ...
    c_hist = []
    c_hist.append(SystemMessage(content=PromptCentral.get_chat_system_prompt()))
    llm = init_chat_model("llama3.1:8b", model_provider="ollama", temperature=0.7)
    
    distill = init_chat_model("llama3.2:3b-instruct-q8_0", model_provider="ollama", temperature=0.7)
    # thoughts
    t_hist = []
    ...
    while True:
        ...
        # generate completion
        target_completion = PromptCentral.get_inject_system_prompt(user_query, thoughts.content)
